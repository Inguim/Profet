...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Linguística, Letras e Artes? </h4>
                <p class="style: text-justify"> As áreas de Linguística, Letras e Artes trabalha
                    na elaboração de material didático e projetos de alfabetização, viabilizando
                    e facilitando a comunicação entre os seres humanos, além de se voltar para
