...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Ciências da Saúde? </h4>
                <p class="style: text-justify"> As Ciências da Saúde são aquelas que estão preocupadas com o corpo e a saúde,
                    seja humana ou animal. São aquelas que pesquisam doenças físicas e tentam
                    encontrar formas de erradica-las ou ao menos reduzi-las, além de tentar trazer
                    conforto para o corpo. Como exemplo disso, nós temos a Educação física e a Fisioterapia.
                </p>
            </div>
