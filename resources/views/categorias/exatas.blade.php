...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Ciências Exatas e da Terra?  </h4>
                <p class="style: text-justify"> São as áreas ligadas a cálculos, estatísticas e projeções físicas
                    ou matemáticas, além de exatidão computacional e todas as suas
                    ramificações. Exemplos disso são Matemática, Ciências da Computação
                    e Geografia.
                </p>
            </div>
