...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Engenharias? </h4>
                <p class="style: text-justify"> As Engenharias são a área da aplicação, onde se coloca em prática
                    diversos conceitos aprendidos na teoria, como a engenharia civil que
                    constroi edificações a partir de cálculos, geometria, etc; e a engenharia
                    computacional, que se preocupada com o hardware (parte física do computador).
                </p>
            </div>
