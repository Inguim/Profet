...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Ciências Sociais Aplicadas? </h4>
                <p class="style: text-justify"> As Ciências Sociais Aplicadas reúne campos
                    de conhecimento interdisciplinares, voltados para os aspectos sociais
                    das diversas realidades humanas. Ou seja, entender quais são
                    as necessidades da sociedade e, também, quais são as consequências de
                    viver em sociedade.
                </p>
            </div>
