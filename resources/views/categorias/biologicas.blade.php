...
<section class="col-12 mt-2 mb-2 bg-light shadow" data-spy="scroll" data-target=".navbar" data-offset="50">
            ...
            <div id="area1" class="container-fluid text-center border-bottom border-dark">
                <h4> O que são as Ciências Biológicas? </h4>
                <p class="style: text-justify"> O termo Ciências Biológicas se refere
                    aos estudos de diferentes seres vivos
                    como plantas, animais, bactérias, etc. Ou seja, Ciências Biológicas é o
                    estudo da Biologia como ciência, que abrange o funcionamento de organismos
                    vivos de diferentes portes, desde escala microscópica até populações
                    inteiras de diferentes formas de vida.
                </p>
            </div>
